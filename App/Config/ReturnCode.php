...
class ReturnCode
{
    ...
    public const USER_NO_CODE = 2010;                     // 用户缺少邀请码
    public const USER_CODE_EXIST = 2011;                     // 用户邀请码已存在
    public const USER_PASSWORD_EXIST = 2012;                         // 用户密码已存在
    public const USER_VERIFICATION_ERROR = 2013;                             //用户验证码错误
    public const USER_CODE_ERROR = 2014;                     // 用户邀请码错误
    ...
    public const USER_NO_CERTIFICATE = 2019;                         // 用户未认证成功
    ...
    public const USER_NO_ENTERPRISE_CERTIFICATE = 2030;                                          // 用户未注册文化号
    public const USER_NO_TEAM_CERTIFICATE = 2031;                                      // 用户未注册小微后台
    public const USER_NO_ZHIBO_CERTIFICATE = 2032;                                      // 用户未注册小微后台
    ...
    // 代理商
    public const AGENT_EXPIRE = 2300;                                    // 代理商过期
    public const AGENT_CODE_LIMIT = 2301;                                    // 代理商可用条数上限
    public const AGENT_NOT_OWN_THIS_CUSTOMER = 2302;                                                //代理商名下没有此用户
    public const INVITE_CODE_HAS_USED = 2310;                                           // 邀请码已使用
    public const INVITE_CODE_NOT_FOUND = 2311;                                           // 未找到此邀请码
    public const INVITE_CODE_LESS_THAN_USER = 2312;                                               // 未找到此邀请码

    // 图片
    public const PICTURE_FORMAT_ERROR = 2401;                                       // 图片格式错误

    // 图片
    public const PAGES_NOT_FOUND = 2501;                               // 期数未找到

    public const APP_NO_NEW_VERSION = 2601;                                   // APP不需要升级

    public const SYNC_INSERT_FAIL = 3101;                                   // 此条目无法启用同步
    public const SYNC_NOT_FOUND = 3102;                               // 此条目无法启用同步
